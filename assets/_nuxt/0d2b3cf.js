        ...
        Ge = function (e, t, base) {
          ...
          if (t) {
            ...
            if (
              ...
              throw new F(n);
            (o = I(new j())).bindURL(this), (this.searchParams = o);
          }
        };
      Ge.prototype = {
        type: "URL",
        ...
        parseHost: function (input) {
          ...
          if ("[" === M(input, 0)) {
            ...
            for (e = "", t = U(input), r = 0; r < t.length; r++)
              e += Pe(t[r], ge);
            this.host = e;
          }
        },
        ...
        shortenPath: function () {
          var path = this.path,
            e = path.length;
          !e ||
            ("file" === this.scheme && 1 === e && Se(path[0], !0)) ||
            path.length--;
        },
        serialize: function () {
          var e = this,
    ...
    741: function (e, t, r) {
        ...
        R = function (input) {
          ...
          input = (function (e) {
            for (var output = [], t = 0, r = e.length; t < r; ) {
              ...
              if (n >= 55296 && n <= 56319 && t < r) {
                var o = w(e, t++);
                56320 == (64512 & o)
                  ? S(output, ((1023 & n) << 10) + (1023 & o) + 65536)
                  : (S(output, n), t--);
              } else S(output, n);
            }
            return output;
          ...
          for (f && S(output, "-"); m < t; ) {
            ...
            for (i = 0; i < input.length; i++)
              (e = input[i]) >= r && e < U && (U = e);
            var y = m + 1;
            if (U - r > d((o - n) / y)) throw new l(c);
            for (n += (U - r) * y, r = U, i = 0; i < input.length; i++) {
              ...
              if (e === r) {
                for (var q = n, k = 36; ; ) {
                  ...
                  var B = q - R,
                    A = 36 - R;
                  S(output, v(H(R + (B % A)))), (q = d(B / A)), (k += 36);
                }
                S(output, v(H(q))), (h = L(n, y, m === f)), (n = 0), m++;
              }
            }
            n++, r++;
          }
      ...
      e.exports = function (input) {
        ...
        for (i = 0; i < t.length; i++)
          (label = t[i]), S(e, m(h, label) ? "xn--" + R(label) : label);
        return P(e, ".");
      };
    },
  },
